...
namespace SamplyGame
{
    ...
    {
        private const float GunOffsetSize = 0.2f;

        // precisione (inferiore - migliore)
        private float currentGunOffset = -GunOffsetSize;
        ...
        protected override async Task OnFire(bool player)
        {
            ...
            await bulletNode.RunActionsAsync(new MoveBy(0.5f, new Vector3(0, 10, 0) * (player ? 1 : -1)), new CallFunc(() => bulletNode.SetScale(0f))); // collapse
