...
namespace SamplyGame
{
    public class Player : Aircraft
    {
        ...
        // estendere la forma predefinita per ottenere collisioni
        protected override Vector3 CollisionShapeSize => new Vector3(3.1f, 1.2f, 1.2f);
        ...
        protected override async void Init()
        {
            ...
            Node.RunActions(new RepeatForever(new DelayTime(5), new EaseBackInOut(new RotateBy(1f, 0f, 0f, 360))));
        }
