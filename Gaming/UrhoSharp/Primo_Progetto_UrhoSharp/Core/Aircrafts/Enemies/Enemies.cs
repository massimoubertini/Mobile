...
{
    // componente per governare tutti i nemici
    public class Enemies : Component
    {
        ...
        private async Task SpawnBats(int count, float pause)
        {
        ...
        private async Task SpawnEnemy(Func<Enemy> enemyFactory, int times)
        {
